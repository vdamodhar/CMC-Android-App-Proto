...
function addOfflineLayers(){
    if(localStorage.getItem('showofflinemap') === 'showofflinemap'){
        ...
        var URL_1 = 'file:///storage/emulated/0/Android/data/com.iict.naavic/files/'+localStorage.getItem('username')+'/vt_group1/{z}/{x}/{y}.pbf';
        ...
        var URL_2 = 'file:///storage/emulated/0/Android/data/com.iict.naavic/files/'+localStorage.getItem('username')+'/vt_group2/{z}/{x}/{y}.pbf';
        ...
        var URL_3 = 'file:///storage/emulated/0/Android/data/com.iict.naavic/files/'+localStorage.getItem('username')+'/vt_group3/{z}/{x}/{y}.pbf';
        ...
        var URL_4 = 'file:///storage/emulated/0/Android/data/com.iict.naavic/files/'+localStorage.getItem('username')+'/vt_navaids/{z}/{x}/{y}.pbf';
        ...
        var URL_5 = 'file:///storage/emulated/0/Android/data/com.iict.naavic/files/'+localStorage.getItem('username')+'/vt_navhazards/{z}/{x}/{y}.pbf';
        ...
        var URL_6 = 'file:///storage/emulated/0/Android/data/com.iict.naavic/files/'+localStorage.getItem('username')+'/vt_sounding/{z}/{x}/{y}.pbf';
